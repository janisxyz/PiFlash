...
class BlockDeviceWriter(
    ...
    private fun requestSense(lun: Int): Sense {
        ...
        val sent = connection.bulkTransfer(bulkOut, packet, Scsi.CBW_SIZE, initTimeoutMs)
        ...
        val n = connection.bulkTransfer(bulkIn, bounce, 18, initTimeoutMs)
        if (n > 0) {
